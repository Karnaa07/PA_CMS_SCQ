...
class Mail {
        ...
        public function pwd_forget_mail(string $email, string $pwd) {
            ...
            try { 
                ...
                '
                    ...
                    <a href="'.SITEURL.'/login"> Connectez vous avec votre nouveau mot de passe : </a>
                    <h2> Si vous n\'êtes pas à l\'origine de cette procédure : <a href="'.SITEURL.'/contact">Nous contacter</a></h2>
        ...
        public function verif_account(string $email, string $name, string $token) {
            ...
            try { 
                ...
                $mail->Body    = 
                '
                    <p>Bonjour '.$name.' tu as crée ton compte chez '.SITENAME.' et nous t\'en remercions 
                    Plus qu\'un pas pour accèder a la formation de l\'année
                    il te suffit de cliquer sur le lien ci-dessous pour valider ton compte</p>
                    <a href='.SITEURL.'/accountActivated?tkn='.$token.'&email='.$email.'>Je confirme mon compte</a></h2>
                    <h2> Si vous n\'êtes pas à l\'origine de cette procédure : <a href="'.SITEURL.'/contact">Nous contacter</a></h2>
                ';// href a modifier lors du déploiement
                $mail->send();
                $mail->smtpClose();
